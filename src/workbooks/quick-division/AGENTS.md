...
10 A4 pages of 1–12 times-table division. Each page mixes simple (dividend ≤ 20), medium (21–60) and hard (61–144) — 14 / 13 / 13 of 40 questions in a 5×8 grid. Stacked fraction layout (`dividend` over `divisor`, then `=`) for timed mental practice. Subheading shows Average / Good / Excellent / Genius timing targets (finish in less than the shown time).
