...
6 A4 pages of column subtraction. Pages 1–2 are three-digit minus two- or three-digit (30 questions, 5×6). Pages 3–6 are four-digit minus three- or four-digit (25 questions, 5×5). Each card has borrow space above the stack.
